...
import { ShareholderSection } from "@/lib/types";
import { ExternalLink } from "lucide-react";
import Link from "next/link";

interface ShareholderProps {
  data: ShareholderSection;
}

/**
 * Shareholder Communication Section Component
 * Displays shareholder communication channels and documents
 * @param {ShareholderSection} data - Shareholder section content
 */
export default function Shareholder({ data }: ShareholderProps) {
  return (
